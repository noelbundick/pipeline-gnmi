...
func (*OpticsEdmWaveInfo_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_optics_edm_wave_info_8e54d71b0ea94d7f, []int{0}
}
...
func (*OpticsEdmWaveInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_optics_edm_wave_info_8e54d71b0ea94d7f, []int{1}
}
...
func (*OpticsEdmChannelWavelengthMapInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_optics_edm_wave_info_8e54d71b0ea94d7f, []int{2}
}
...
func (*OpticsEdmWaveInfo_COMBINED) Descriptor() ([]byte, []int) {
	return fileDescriptor_optics_edm_wave_info_8e54d71b0ea94d7f, []int{3}
}
...
func (m *OpticsEdmWaveInfo_COMBINED) XXX_DiscardUnknown() {
	xxx_messageInfo_OpticsEdmWaveInfo_COMBINED.DiscardUnknown(m)
}

var xxx_messageInfo_OpticsEdmWaveInfo_COMBINED proto.InternalMessageInfo
...
func init() {
	proto.RegisterFile("optics_edm_wave_info.proto", fileDescriptor_optics_edm_wave_info_8e54d71b0ea94d7f)
}

var fileDescriptor_optics_edm_wave_info_8e54d71b0ea94d7f = []byte{
