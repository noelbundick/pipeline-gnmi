...
func (*RsvpMgmtGlblBwPoolInfo_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_rsvp_mgmt_glbl_bw_pool_info_bfcb6acb86ece7ac, []int{0}
}
...
func (dst *RsvpMgmtGlblBwPoolInfo_KEYS) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RsvpMgmtGlblBwPoolInfo_KEYS.Merge(dst, src)
}
...
type RsvpMgmtGlblBwPoolInfo struct {
	...
	MaxResPoolPercent uint32 `protobuf:"varint,50,opt,name=max_res_pool_percent,json=maxResPoolPercent" json:"max_res_pool_percent,omitempty"`
	// BC0 I/F percent B/W
	Bc0Percent uint32 `protobuf:"varint,51,opt,name=bc0_percent,json=bc0Percent" json:"bc0_percent,omitempty"`
	// BC1 I/F percent B/W
	Bc1Percent uint32 `protobuf:"varint,52,opt,name=bc1_percent,json=bc1Percent" json:"bc1_percent,omitempty"`
	// Is maximum reservable default I/F percent configured
	IsMaxResPoolPercentConfigured bool `protobuf:"varint,53,opt,name=is_max_res_pool_percent_configured,json=isMaxResPoolPercentConfigured" json:"is_max_res_pool_percent_configured,omitempty"`
	// Is BC0 default I/F percent configured
	IsBc0PercentConfigured bool `protobuf:"varint,54,opt,name=is_bc0_percent_configured,json=isBc0PercentConfigured" json:"is_bc0_percent_configured,omitempty"`
	// Is BC1 default I/F percent configured
	IsBc1PercentConfigured bool `protobuf:"varint,55,opt,name=is_bc1_percent_configured,json=isBc1PercentConfigured" json:"is_bc1_percent_configured,omitempty"`
	// Bandwith configuration model currently in use (MAM/RDM)
	BandwidthConfigurationModel string   `protobuf:"bytes,56,opt,name=bandwidth_configuration_model,json=bandwidthConfigurationModel" json:"bandwidth_configuration_model,omitempty"`
	XXX_NoUnkeyedLiteral        struct{} `json:"-"`
	XXX_unrecognized            []byte   `json:"-"`
	XXX_sizecache               int32    `json:"-"`
}
...
func (*RsvpMgmtGlblBwPoolInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_rsvp_mgmt_glbl_bw_pool_info_bfcb6acb86ece7ac, []int{1}
}
...
func (dst *RsvpMgmtGlblBwPoolInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RsvpMgmtGlblBwPoolInfo.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("rsvp_mgmt_glbl_bw_pool_info.proto", fileDescriptor_rsvp_mgmt_glbl_bw_pool_info_bfcb6acb86ece7ac)
}

var fileDescriptor_rsvp_mgmt_glbl_bw_pool_info_bfcb6acb86ece7ac = []byte{
