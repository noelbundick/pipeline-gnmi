...
func (*RsvpMgmtAllDbCounters_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_rsvp_mgmt_all_db_counters_0e15b4eb8cc7202d, []int{0}
}
...
func (dst *RsvpMgmtAllDbCounters_KEYS) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RsvpMgmtAllDbCounters_KEYS.Merge(dst, src)
}
...
type RsvpMgmtAllDbCounters struct {
	// Number of sessions
	Sessions uint32 `protobuf:"varint,50,opt,name=sessions" json:"sessions,omitempty"`
	// Number of locally created and incoming path states
	IncomingPaths uint32 `protobuf:"varint,51,opt,name=incoming_paths,json=incomingPaths" json:"incoming_paths,omitempty"`
	// Number of outgoing path states
	OutgoingPaths uint32 `protobuf:"varint,52,opt,name=outgoing_paths,json=outgoingPaths" json:"outgoing_paths,omitempty"`
	// Number of locally created and incoming reservation states
	IncomingReservations uint32 `protobuf:"varint,53,opt,name=incoming_reservations,json=incomingReservations" json:"incoming_reservations,omitempty"`
	// Number of outgoing reservation states
	OutgoingReservations uint32 `protobuf:"varint,54,opt,name=outgoing_reservations,json=outgoingReservations" json:"outgoing_reservations,omitempty"`
	// Number of Interfaces
	Interfaces           uint32   `protobuf:"varint,55,opt,name=interfaces" json:"interfaces,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*RsvpMgmtAllDbCounters) Descriptor() ([]byte, []int) {
	return fileDescriptor_rsvp_mgmt_all_db_counters_0e15b4eb8cc7202d, []int{1}
}
...
func init() {
	proto.RegisterFile("rsvp_mgmt_all_db_counters.proto", fileDescriptor_rsvp_mgmt_all_db_counters_0e15b4eb8cc7202d)
}

var fileDescriptor_rsvp_mgmt_all_db_counters_0e15b4eb8cc7202d = []byte{
