...
func (*RsvpMgmtEventCountInfo_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_rsvp_mgmt_event_count_info_75765df1224e7586, []int{0}
}
...
func (*RsvpMgmtEventCountInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_rsvp_mgmt_event_count_info_75765df1224e7586, []int{1}
}
...
func init() {
	proto.RegisterFile("rsvp_mgmt_event_count_info.proto", fileDescriptor_rsvp_mgmt_event_count_info_75765df1224e7586)
}

var fileDescriptor_rsvp_mgmt_event_count_info_75765df1224e7586 = []byte{
