...
func (*RsvpSyncCountInfo_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_rsvp_sync_count_info_9081faeb2fef6aa8, []int{0}
}
...
func (*RsvpSyncCountInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_rsvp_sync_count_info_9081faeb2fef6aa8, []int{1}
}
...
func init() {
	proto.RegisterFile("rsvp_sync_count_info.proto", fileDescriptor_rsvp_sync_count_info_9081faeb2fef6aa8)
}

var fileDescriptor_rsvp_sync_count_info_9081faeb2fef6aa8 = []byte{
