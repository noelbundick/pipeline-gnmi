...
func (*MplsRsvpGlobalCounters_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_mpls_rsvp_global_counters_a35dc3faa9fa339d, []int{0}
}
...
func (*MplsRsvpGlobalCounters) Descriptor() ([]byte, []int) {
	return fileDescriptor_mpls_rsvp_global_counters_a35dc3faa9fa339d, []int{1}
}
...
func init() {
	proto.RegisterFile("mpls_rsvp_global_counters.proto", fileDescriptor_mpls_rsvp_global_counters_a35dc3faa9fa339d)
}

var fileDescriptor_mpls_rsvp_global_counters_a35dc3faa9fa339d = []byte{
