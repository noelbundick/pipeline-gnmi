...
func (*RsvpSyncCountInfo_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_rsvp_sync_count_info_51269ef9f1792764, []int{0}
}
...
func (*RsvpSyncCountInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_rsvp_sync_count_info_51269ef9f1792764, []int{1}
}
...
func init() {
	proto.RegisterFile("rsvp_sync_count_info.proto", fileDescriptor_rsvp_sync_count_info_51269ef9f1792764)
}

var fileDescriptor_rsvp_sync_count_info_51269ef9f1792764 = []byte{
