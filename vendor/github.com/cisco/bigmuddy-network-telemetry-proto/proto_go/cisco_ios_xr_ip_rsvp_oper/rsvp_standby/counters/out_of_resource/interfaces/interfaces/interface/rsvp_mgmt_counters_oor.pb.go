...
func (*RsvpMgmtCountersOor_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_rsvp_mgmt_counters_oor_1e734b2912b459dc, []int{0}
}
...
func (dst *RsvpMgmtCountersOor_KEYS) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RsvpMgmtCountersOor_KEYS.Merge(dst, src)
}
...
type RsvpMgmtCountersOor struct {
	...
	DroppedPathMessages  uint32   `protobuf:"varint,50,opt,name=dropped_path_messages,json=droppedPathMessages" json:"dropped_path_messages,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*RsvpMgmtCountersOor) Descriptor() ([]byte, []int) {
	return fileDescriptor_rsvp_mgmt_counters_oor_1e734b2912b459dc, []int{1}
}
...
func (dst *RsvpMgmtCountersOor) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RsvpMgmtCountersOor.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("rsvp_mgmt_counters_oor.proto", fileDescriptor_rsvp_mgmt_counters_oor_1e734b2912b459dc)
}

var fileDescriptor_rsvp_mgmt_counters_oor_1e734b2912b459dc = []byte{
