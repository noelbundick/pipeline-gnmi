...
func (*MplsLmBwAllocCommonInfo_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_mpls_lm_bw_alloc_common_info_8b8ebfe620540e52, []int{0}
}
...
func (*MplsLmBwAllocCommonInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_mpls_lm_bw_alloc_common_info_8b8ebfe620540e52, []int{1}
}
...
func init() {
	proto.RegisterFile("mpls_lm_bw_alloc_common_info.proto", fileDescriptor_mpls_lm_bw_alloc_common_info_8b8ebfe620540e52)
}

var fileDescriptor_mpls_lm_bw_alloc_common_info_8b8ebfe620540e52 = []byte{
