...
func (*MplsTeSoftPreemptionGlobalInfo_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_mpls_te_soft_preemption_global_info_76da397e15237976, []int{0}
}
...
func (*MplsTeSoftPreemptionGlobalInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_mpls_te_soft_preemption_global_info_76da397e15237976, []int{1}
}
...
func init() {
	proto.RegisterFile("mpls_te_soft_preemption_global_info.proto", fileDescriptor_mpls_te_soft_preemption_global_info_76da397e15237976)
}

var fileDescriptor_mpls_te_soft_preemption_global_info_76da397e15237976 = []byte{
