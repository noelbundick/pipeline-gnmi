...
func (*MplsLmBwAllocCommonInfo_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_mpls_lm_bw_alloc_common_info_c48a03a45c421c2e, []int{0}
}
...
func (dst *MplsLmBwAllocCommonInfo_KEYS) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MplsLmBwAllocCommonInfo_KEYS.Merge(dst, src)
}
...
type MplsLmBwAllocCommonInfo struct {
	...
	BandwidthHoldTime    uint32   `protobuf:"varint,52,opt,name=bandwidth_hold_time,json=bandwidthHoldTime" json:"bandwidth_hold_time,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*MplsLmBwAllocCommonInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_mpls_lm_bw_alloc_common_info_c48a03a45c421c2e, []int{1}
}
...
func (dst *MplsLmBwAllocCommonInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MplsLmBwAllocCommonInfo.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("mpls_lm_bw_alloc_common_info.proto", fileDescriptor_mpls_lm_bw_alloc_common_info_c48a03a45c421c2e)
}

var fileDescriptor_mpls_lm_bw_alloc_common_info_c48a03a45c421c2e = []byte{
