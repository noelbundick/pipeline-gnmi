...
func (*MplsTeSoftPreemptionGlobalInfo_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_mpls_te_soft_preemption_global_info_8fd5f3b873d68552, []int{0}
}
...
func (dst *MplsTeSoftPreemptionGlobalInfo_KEYS) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MplsTeSoftPreemptionGlobalInfo_KEYS.Merge(dst, src)
}
...
type MplsTeSoftPreemptionGlobalInfo struct {
	...
	// Is global soft-preemption timeout interval configured
	IsTimeoutIntervalConfigured bool `protobuf:"varint,51,opt,name=is_timeout_interval_configured,json=isTimeoutIntervalConfigured" json:"is_timeout_interval_configured,omitempty"`
	// Global soft-preemption timeout interval
	TimeoutInterval      uint32   `protobuf:"varint,52,opt,name=timeout_interval,json=timeoutInterval" json:"timeout_interval,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*MplsTeSoftPreemptionGlobalInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_mpls_te_soft_preemption_global_info_8fd5f3b873d68552, []int{1}
}
...
func (dst *MplsTeSoftPreemptionGlobalInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MplsTeSoftPreemptionGlobalInfo.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("mpls_te_soft_preemption_global_info.proto", fileDescriptor_mpls_te_soft_preemption_global_info_8fd5f3b873d68552)
}

var fileDescriptor_mpls_te_soft_preemption_global_info_8fd5f3b873d68552 = []byte{
