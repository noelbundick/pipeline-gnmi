...
func (*TeStatsSigT_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_te_stats_sig_t_1e86a9aa6c7892bc, []int{0}
}
...
func (*TeStatsSigT) Descriptor() ([]byte, []int) {
	return fileDescriptor_te_stats_sig_t_1e86a9aa6c7892bc, []int{1}
}
...
func init() {
	proto.RegisterFile("te_stats_sig_t.proto", fileDescriptor_te_stats_sig_t_1e86a9aa6c7892bc)
}

var fileDescriptor_te_stats_sig_t_1e86a9aa6c7892bc = []byte{
