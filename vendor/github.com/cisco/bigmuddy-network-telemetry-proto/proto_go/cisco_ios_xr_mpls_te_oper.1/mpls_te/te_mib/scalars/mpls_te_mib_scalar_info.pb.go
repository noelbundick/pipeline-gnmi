...
func (*MplsTeMibScalarInfo_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_mpls_te_mib_scalar_info_a49b6c0ab90d5674, []int{0}
}
...
func (dst *MplsTeMibScalarInfo_KEYS) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MplsTeMibScalarInfo_KEYS.Merge(dst, src)
}
...
type MplsTeMibScalarInfo struct {
	MplsTunnelConfigured          uint32   `protobuf:"varint,50,opt,name=mpls_tunnel_configured,json=mplsTunnelConfigured" json:"mpls_tunnel_configured,omitempty"`
	MplsTunnelActive              uint32   `protobuf:"varint,51,opt,name=mpls_tunnel_active,json=mplsTunnelActive" json:"mpls_tunnel_active,omitempty"`
	MplsTunnelTeDistProto         uint32   `protobuf:"varint,52,opt,name=mpls_tunnel_te_dist_proto,json=mplsTunnelTeDistProto" json:"mpls_tunnel_te_dist_proto,omitempty"`
	MplsTunnelMaxHops             uint32   `protobuf:"varint,53,opt,name=mpls_tunnel_max_hops,json=mplsTunnelMaxHops" json:"mpls_tunnel_max_hops,omitempty"`
	MplsTunnelNotificationMaxRate uint32   `protobuf:"varint,54,opt,name=mpls_tunnel_notification_max_rate,json=mplsTunnelNotificationMaxRate" json:"mpls_tunnel_notification_max_rate,omitempty"`
	XXX_NoUnkeyedLiteral          struct{} `json:"-"`
	XXX_unrecognized              []byte   `json:"-"`
	XXX_sizecache                 int32    `json:"-"`
}
...
func (*MplsTeMibScalarInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_mpls_te_mib_scalar_info_a49b6c0ab90d5674, []int{1}
}
...
func (dst *MplsTeMibScalarInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MplsTeMibScalarInfo.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("mpls_te_mib_scalar_info.proto", fileDescriptor_mpls_te_mib_scalar_info_a49b6c0ab90d5674)
}

var fileDescriptor_mpls_te_mib_scalar_info_a49b6c0ab90d5674 = []byte{
