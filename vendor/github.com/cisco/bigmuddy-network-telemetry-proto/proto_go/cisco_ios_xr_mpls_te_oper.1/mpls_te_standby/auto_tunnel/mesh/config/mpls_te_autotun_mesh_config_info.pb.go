...
func (*MplsTeAutotunMeshConfigInfo_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_mpls_te_autotun_mesh_config_info_85461e4d99dfb741, []int{0}
}
...
func (*MplsTeAutotunMeshConfigInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_mpls_te_autotun_mesh_config_info_85461e4d99dfb741, []int{1}
}
...
func init() {
	proto.RegisterFile("mpls_te_autotun_mesh_config_info.proto", fileDescriptor_mpls_te_autotun_mesh_config_info_85461e4d99dfb741)
}

var fileDescriptor_mpls_te_autotun_mesh_config_info_85461e4d99dfb741 = []byte{
