...
func (*MplsTeBfdSummary_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_mpls_te_bfd_summary_e23f0bc1db0b0398, []int{0}
}
...
func (*MplsTeBfdSummary) Descriptor() ([]byte, []int) {
	return fileDescriptor_mpls_te_bfd_summary_e23f0bc1db0b0398, []int{1}
}
...
func init() {
	proto.RegisterFile("mpls_te_bfd_summary.proto", fileDescriptor_mpls_te_bfd_summary_e23f0bc1db0b0398)
}

var fileDescriptor_mpls_te_bfd_summary_e23f0bc1db0b0398 = []byte{
