...
func (*MplsTeSyncCountInfo_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_mpls_te_sync_count_info_6aeb8025cdfe5ec8, []int{0}
}
...
func (*MplsTeSyncCountInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_mpls_te_sync_count_info_6aeb8025cdfe5ec8, []int{1}
}
...
func init() {
	proto.RegisterFile("mpls_te_sync_count_info.proto", fileDescriptor_mpls_te_sync_count_info_6aeb8025cdfe5ec8)
}

var fileDescriptor_mpls_te_sync_count_info_6aeb8025cdfe5ec8 = []byte{
