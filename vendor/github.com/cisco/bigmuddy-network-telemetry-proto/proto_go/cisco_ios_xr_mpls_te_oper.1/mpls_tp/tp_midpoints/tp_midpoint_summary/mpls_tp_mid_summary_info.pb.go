...
// Transport profile mid-point LSP summary information
...
func (*MplsTpMidSummaryInfo_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_mpls_tp_mid_summary_info_9723b5e541764121, []int{0}
}
...
func (dst *MplsTpMidSummaryInfo_KEYS) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MplsTpMidSummaryInfo_KEYS.Merge(dst, src)
}
...
type MplsTpMidSummaryInfo struct {
	...
	MidPoints uint32 `protobuf:"varint,50,opt,name=mid_points,json=midPoints" json:"mid_points,omitempty"`
	// Total number of forward LSPs that are Up
	UpForwardLsPs uint32 `protobuf:"varint,51,opt,name=up_forward_ls_ps,json=upForwardLsPs" json:"up_forward_ls_ps,omitempty"`
	// Total number of forward LSPs that are Down
	DownForwardLsPs uint32 `protobuf:"varint,52,opt,name=down_forward_ls_ps,json=downForwardLsPs" json:"down_forward_ls_ps,omitempty"`
	// Total number of reverse LSPs that are Up
	UpReverseLsPs uint32 `protobuf:"varint,53,opt,name=up_reverse_ls_ps,json=upReverseLsPs" json:"up_reverse_ls_ps,omitempty"`
	// Total number of reverse LSPs that are Down
	DownReverseLsPs      uint32   `protobuf:"varint,54,opt,name=down_reverse_ls_ps,json=downReverseLsPs" json:"down_reverse_ls_ps,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*MplsTpMidSummaryInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_mpls_tp_mid_summary_info_9723b5e541764121, []int{1}
}
...
func (dst *MplsTpMidSummaryInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MplsTpMidSummaryInfo.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("mpls_tp_mid_summary_info.proto", fileDescriptor_mpls_tp_mid_summary_info_9723b5e541764121)
}

var fileDescriptor_mpls_tp_mid_summary_info_9723b5e541764121 = []byte{
